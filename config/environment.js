...
const development={
    ...
    google_client_id: "17146081526-c6nufvh2va0puikrbstscjsemekenm4g.apps.googleusercontent.com",
...
module.exports = eval(process.env.slikup_environment)==undefined ? development : eval(process.env.slikup_environment);